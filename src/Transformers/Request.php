...
use Lawoole\Utils\MimeTypeUtils;
...
class Request
{
     ...
     * @return Request
     */
    public static function make(SwooleRequest $swooleRequest): Request
    {
     ...
     * @return void
     */
    protected function createIlluminateRequest(array $get, array $post, array $cookie, array $files, array $server, $content = null): void
    {
     ...
     */
    public function toIlluminate(): IlluminateRequest
    {
     ...
     * @return array
     */
    protected static function toIlluminateParameters(SwooleRequest $request): array
    {
        $get = $request->get ?? [];
        $post = $request->post ?? [];
     ...
     * @return boolean
     */
    public static function handleStatic(SwooleRequest $swooleRequest, \Swoole\Http\Response $swooleResponse, string $publicPath): bool
    {
        ...
        $swooleResponse->header('Content-Type', MimeTypeUtils::get($extension));
